      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-0.5">Cash receipts and payments ledger</p>
          </div>
        </div>
        ...
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              ...
              <TableRow><TableCell colSpan={8} className="text-center text-gray-400 py-8">No cash transactions in this period</TableCell></TableRow>
            ) : (
              entries.map((e, i) => (
